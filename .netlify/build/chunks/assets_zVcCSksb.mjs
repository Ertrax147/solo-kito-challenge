import { A as MissingImageDimension, C as InvalidImageService, N as NoImageMetadata, Q as AstroError, V as RemoteImageNotAllowed, X as UnsupportedImageFormat, Y as UnsupportedImageConversion, c as ExpectedImage, d as FailedToFetchRemoteImageDimensions, l as ExpectedImageOptions, t as path_exports, u as ExpectedNotESMImage, w as LocalImageUsedWrongly, y as IncompatibleDescriptorOptions } from "./path_H8S9N1VA.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./image-service_BIB2j7fW.mjs").catch((e) => {
...
//#endregion
export { inferRemoteSize as a, isRemoteImage as c, verifyOptions as i, resolveSrc as l, getImage as n, fetchWithRedirects as o, baseService as r, isESMImportedImage as s, getConfiguredImageService as t };
