...
//#region src/pages/api/summoner.js
var summoner_exports = /* @__PURE__ */ __exportAll({
	GET: () => GET,
	prerender: () => false
});
var DDRAGON_VER = "16.15.1";
var DEFAULT_API_KEY = "RGAPI-a6e6ae1e-068c-484d-883d-a7672ab00feb";
var platformMap = {
	"LAS": {
		platform: "la2",
		regional: "americas",
...
async function GET({ request }) {
	...
	if (!gameName || !tagLine) return new Response(JSON.stringify({ error: "Falta el nombre de invocador o tag" }), {
		status: 400,
		headers: {
